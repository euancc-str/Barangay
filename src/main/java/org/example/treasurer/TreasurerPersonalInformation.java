...
public class TreasurerPersonalInformation extends JPanel {
    ...
    private JPanel createFormPanel() {
        ...
        // Name Row - Changed to Treasurer's name "H.Min Anduja"
        ...
        namePanel.add(createFieldPanel("First Name *", txtFirstName = createTextField("H.Min")));
        namePanel.add(createFieldPanel("Middle Name *", txtMiddleName = createTextField("")));
        namePanel.add(createFieldPanel("Last Name *", txtLastName = createTextField("Anduja")));
        ...
        cmbSex.setSelectedItem("Female"); // Changed to Female for Treasurer
        ...
        cmbCivilStatus.setSelectedItem("Single"); // Changed to Single
        ...
        streetPanel.add(createFieldPanel("Street/Barangay/Municipality *",
            txtStreet = createTextField("Purok 3 Brgy. Sichiyang Daet Camarines Norte")), // Changed address
            BorderLayout.CENTER);
        ...
        contactPanel.add(createFieldPanel("Email Address", txtEmail = createTextField("Anduja@gmail.com"))); // Changed email
        ...
        btnDone.setBackground(new Color(70, 130, 180)); // Blue color for Treasurer
    ...
    // Add this at the end of the TreasurerPersonalInformation class (before the closing brace):
