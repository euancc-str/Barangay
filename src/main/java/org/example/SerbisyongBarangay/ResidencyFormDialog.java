...
public class ResidencyFormDialog extends JDialog {
    ...
    private JTextField txtYearsResiding;
    ...
    private void loadResidentData() {
        if (currentResident != null) {
            ...
            if (currentResident.getDob() != null) {
                cmbBirthDate.setSelectedItem(currentResident.getDob().toString());
            }
            ...
            if (currentResident.getPurok() != null) {
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel title = new JLabel("<html><center><b>CERTIFICATE OF RESIDENCY FORM</b><br>" +
    ...
    private JPanel createFormPanel() {
        ...
        // 7. Citizenship (Specific to Residency)
        txtCitizenship = createStyledTextField(25);
        row = addField(formPanel, gbc, "Citizenship:", txtCitizenship, row, 1, 3, labelFont, labelColor);


        // 8. Years Residing (Specific to Residency)
        txtYearsResiding = createStyledTextField(25);
        txtYearsResiding.addKeyListener(new KeyAdapter() {
            @Override
        ...
        row = addField(formPanel, gbc, "Years Residing:", txtYearsResiding, row, 1, 3, labelFont, labelColor);
        ...
        row = addField(formPanel, gbc, "Full Address:", txtCurrentAddress, row, 1, 3, labelFont, labelColor);


        // 12. Purpose (Text Area)
    ...
    private JPanel createButtonPanel() {
        ...
        proceedButton.addActionListener(e -> {
            ...
            if (docType == null) {
                JOptionPane.showMessageDialog(this, "Error: Document Type 'Certificate of Residency' not found in database settings.");
                return;
            }
            ...
            JOptionPane.showMessageDialog(this,
                    "Certificate of Residency request submitted successfully!",
                    "Success",
    ...
    private boolean validateForm() {
        ...
        if (txtCitizenship.getText().trim().isEmpty()) {
            errors.append("• Citizenship is required\n");
        }
        if (txtYearsResiding.getText().trim().isEmpty()) {
            errors.append("• Years Residing is required\n");
        }
        ...
        if (txtPurpose.getText().length() > 250) {
            errors.append("• Purpose length is too long\n");
        }
