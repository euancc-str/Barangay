...
public class successyourinformationframe extends JDialog {
    protected final Color greencolor = new Color(86, 149, 65);
    protected final Color redcolor = new Color(255, 49, 49);

    public successyourinformationframe(Frame owner) {
        ...
        JLabel contentLabel = new JLabel(
                "<html><p align='center'>" +
                        "<b>Success!<br>Your information has been <br>updated</b>"
                        +
                        "</p></html>");
        ...
        // 2. LATER Button (Gray)
        JButton successbuton = new JButton("SUCCESS");
        successbuton.setFont(new Font("Arial", Font.BOLD, 18));
        successbuton.setForeground(Color.white); // Dark Gray text
        successbuton.setBackground(greencolor); // Light Gray background

        // Simple customization for a block look
        successbuton.setBorderPainted(false);
        successbuton.setFocusPainted(false);
        successbuton.setPreferredSize(new Dimension(0, 50));
        successbuton.addActionListener(new ActionListener() {
