...
public class congratulationsyouhavesucreqaformframe extends JDialog {
    protected final Color greencolor = new Color(86, 149, 65);
    protected final Color redcolor = new Color(255, 49, 49);

    protected final Color pink=new Color(255, 102, 196);

    public congratulationsyouhavesucreqaformframe(Frame owner,String typeofForm) {
        ...
        JLabel contentLabel = new JLabel(
                "<html><p align='center'>" +
                        "<b>CONGRATULATIONS!<br> You have successfully requested<br> a " + typeofForm 
                        +
                        "</p></html>");
        ...
        JButton checkdocstatus = new JButton("CHECK STATUS");
        checkdocstatus.setFont(new Font("Arial", Font.BOLD, 18));
        checkdocstatus.setForeground(Color.WHITE);
        checkdocstatus.setBackground(pink); // Bright Orange

        // Simple customization for a block look
        checkdocstatus.setBorderPainted(false);
        checkdocstatus.setFocusPainted(false);
        checkdocstatus.setPreferredSize(new Dimension(0, 50));
        checkdocstatus.addActionListener(e -> {
            // JOptionPane.showMessageDialog(this, "Editing details...");
            // dispose();
            dispose();
            CheckDocumentStatusFrame cehck=new CheckDocumentStatusFrame();
            cehck.setVisible(true);
        });

        // 2. LATER Button (Gray)
        JButton okaybtn = new JButton("OKAY");
        okaybtn.setFont(new Font("Arial", Font.BOLD, 18));
        okaybtn.setForeground(Color.white); // Dark Gray text
        okaybtn.setBackground(greencolor); // Light Gray background

        // Simple customization for a block look
        okaybtn.setBorderPainted(false);
        okaybtn.setFocusPainted(false);
        okaybtn.setPreferredSize(new Dimension(0, 50));
        ...
        buttonPanel.add(checkdocstatus);
        buttonPanel.add(okaybtn);
